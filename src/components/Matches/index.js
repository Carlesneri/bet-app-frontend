...
const Matches = () => {
  ...
  matches.sort((a, b) => Math.max(b.player1Perc, b.player2Perc) - Math.max(a.player1Perc, a.player2Perc))

  return matches.length ? <div className="matches">{matches.map((match, i) => <Match key={i} match={match}/>)}
  </div> 
